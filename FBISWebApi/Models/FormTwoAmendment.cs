...
namespace FBISWebApi.Models
{
    public class FormTwoAmendment
    {
        ...
        public string PERSON_APPOINTED_NAME { get; set; }
        ...
        public string AMENDMENT_FEE { get; set; }
        public string DIFFERENCE_FEE { get; set; }
        public string TOTAL_AMOUNT { get; set; }
        public string FEE_PAID_DATE { get; set; }
        public string TOTAL_AMOUNT_IN_WORDS { get; set; }
